...
tour_2_image = URI.open("https://images.unsplash.com/photo-1558551649-e44c8f992010?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Nnx8YW1zdGVyZGFtfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
tour_2.photos.attach(io: tour_2_image, filename: "tourimg3.png", content_type: "image/png")
tour_2.save!
...
tour_4_image = URI.open("https://images.unsplash.com/photo-1597998523552-db3bf55207e1?ixid=MXwxMjA3fDB8MHxzZWFyY2h8NHx8a2V1a2VuaG9mfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
...
tour_5_image = URI.open("https://images.unsplash.com/photo-1556526945-0a2ef2955165?ixid=MXwxMjA3fDB8MHxzZWFyY2h8NDd8fGtldWtlbmhvZnxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
...
tour_6_image = URI.open("https://images.unsplash.com/photo-1600506113428-6bca08071925?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTR8fHV0cmVjaHR8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
...
tour_7_image = URI.open("https://images.unsplash.com/photo-1541944766239-695501c0c318?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mnx8cm90dGVyZGFtfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
...
tour_8_image = URI.open("https://images.unsplash.com/photo-1563800037628-2b1bfb1876f2?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTB8fHdpbmRtaWxsJTIwaG9sbGFuZHxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
...
tour_9_image = URI.open("https://images.unsplash.com/photo-1524047934617-cb782c24e5f3?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MXx8YmlrZSUyMCUyMGFtc3RlcmRhbXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60")
